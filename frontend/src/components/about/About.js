          ...
          <div className={classes.textContainer}>
            <Typography>
              ...
              <Typography className={classes.text}>
                Vi er en broderduo og har absolutt elsket å bake med foreldrene
                og besteforeldrene våre siden vi var veldig små. Vi har tatt
                foreldrene våre kunnskap og ferdigheter og ønsket å dele
                kreasjonene våre med deg. Brødology ble først opprettet i vårt
                familiekjøkken i oppveksten, og det har vært vår lidenskap
                siden.
              </Typography>
              <Typography className={classes.text}>
                Vi håper du liker å spise disse godbitene like mye som vi har
                likt å bake dem!
              </Typography>
              <Typography className={classes.text}>
